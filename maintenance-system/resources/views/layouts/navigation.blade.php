<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            {{-- 1. LOGO E NAVEGAÇÃO SUPERIOR ESQUERDA --}}
    ...
    {{-- ==========================================================
    4. MOBILE MENU (Responsive Navigation Menu)
    ========================================================== --}}
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        
        {{-- O seu Menu Mobile deve ter apenas os links de Configurações, pois a Sidebar não aparece no mobile --}}

        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                {{ __('Dashboard') }}
            </x-responsive-nav-link>
            {{-- ADICIONE AQUI OS LINKS DE MÁQUINAS, MANUTENÇÕES, ETC., PARA MOBILE --}}
